    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //user.Claims.Add(new IdentityUserClaim<string> { ClaimType = "Eventos", ClaimValue = "Consultar" });
                //user.Claims.Add(new IdentityUserClaim<string> { ClaimType = "Eventos", ClaimValue = "Gravar" });
                //user.Claims.Add(new IdentityUserClaim<string> { ClaimType = "Eventos", ClaimValue = "Excluir" });
                ...
                if (result.Succeeded)
                {
                    ...
                    // Cria o organizador usando o Id do user criado acima, assim não precisa criar um vínculo entre as tabelas AspNetUsers e Organizadores
        ...
        {
            return RedirectToAction(nameof(ErrosController.Erros), "Erros", new { id = 403 });
        }
